...
<html>
<head>
    <title><s:text name="content.model"/><s:text name="title.add"/></title>
</head>
<body>

<table class="page-form" cellspacing="0" width="100%">
    <tr>
        <td class="page-form-title"><s:text name="content.model"/><s:text name="title.add"/></td>
    </tr>
</table>
<br/>

<s:form action="create" method="post" enctype="multipart/form-data" theme="simple">

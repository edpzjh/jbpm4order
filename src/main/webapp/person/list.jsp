...
<html>
<head>
    <title><s:text name="person.model"/><s:text name="title.list"/></title>
</head>
<body>

<table class="page-form" cellspacing="0" width="100%">
    <tr>
        <td class="page-form-title"><s:text name="person.model"/><s:text name="title.list"/></td>
    </tr>
</table>
<br/>

<s:form action="list" method="post" id="search" namespace="/person" theme="simple">
    <table class="page-form" cellspacing="0" width="100%">
        <tr>
        ...
        <tr>
            <td colspan="4">
                <table cellspacing="0" width="100%">
                    <tr>
                        <td width="40%"><s:url id="url" action="new" /><a href="<s:property value="#url"/>"><s:text name="action.new"/><s:text name="person.model"/></a></td>
...
<table id="list" class="list-table" cellspacing="0" width="100%" border="1">
    <tr class="list-table-header">
        <th><page:order fixOrderBy="first_name"><s:text name="person.firstName"/></page:order></th>
        <th><page:order fixOrderBy="last_name"><s:text name="person.lastName"/></page:order></th>
    ...
    <s:iterator value="listPerson" status="status">
